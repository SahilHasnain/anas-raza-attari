...
async function exportData() {
  ...
  try {
    ...
    console.log('      https://cdn.jsdelivr.net/gh/SahilHasnain/anas-raza-attari@main/static-exports/naats-export.json');
    console.log('      https://cdn.jsdelivr.net/gh/SahilHasnain/anas-raza-attari@main/static-exports/channels-export.json');
    console.log('');
